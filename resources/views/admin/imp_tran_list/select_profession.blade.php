        ...
        <div class="page-content">
            <div class="row">
                ...
                <div class="col-md-4" style="padding-top:20px;">
                    <h2 style="color: green">Activity Input Bank Statement</h2>
                    <form action="#" name="topform">
                        <div class="form-group">
                            <select class="form-control" id="proid" name="proid" tabindex="7" onchange="location = this.value">
                                <option>Activity Input Bank Statement</option>
                                @foreach($client->professions as $profession)
                                    <option value="{{route('bs_input.imp_tran_list',['client' => $client->id,'profession' => $profession->id])}}">{{$profession->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </form>
