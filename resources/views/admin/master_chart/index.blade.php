                                            ...
                                            @foreach($subCategory->additionalCategory as $additionalCategory)
                                                <tr>
                                                    ...
                                                    @can('admin.master-chart.delete')
                                                        ...
                                                        <td>
                                                            <a class="_delete" data-route="{{route('delete.master.chart.additional.category', ['id' => $additionalCategory->id])}}"></a>
                                                        </td>
                                                        @else
                                                            <td></td>
                                                        @endif
                                                    ...
                                                    @if($masterAccountCode->additional_category_id == $additionalCategory->id)
                                                        <tr>
                                                            <td style="color: #1B6AAA">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                                <a type="button"  class="edit-account-code" data-id="{{$masterAccountCode->id}}" data-name="{{$masterAccountCode->name}}" data-note="{{$masterAccountCode->note}}" style="cursor: pointer">
                                                            ...
                                                            @can('admin.master-chart.delete')
                                                                ...
                                                                <td>
                                                                    <a class="_delete" data-route="{{route('delete.master.chart.account.code', ['id' => $masterAccountCode->id])}}"></a>
                                                                </td>
                                                                @else
                                                                    <td></td>
                                                                @endif
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control heading select2" id="industry_category_id" name="industry_category_id[]" multiple="multiple" required>
                                                <option value="">Please Select</option>
                                                    @foreach($industryCategories as $id => $industryCategory)
                                                        <option value="{{$id}}" {{old('industry_category_id') == $id?'selected':''}}>{{$industryCategory}}</option>
                                                    @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="input-group">
                                            <span type="text" style="width: 30%" id="auto-code" class="form-control text-center" autocomplete="off" readonly></span>
...
{{--                                                <small class="text-danger">{{$errors->first('is_for_all_professions')}}</small>--}}
{{--                                            @endif--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
                                    <div class="col-md-3">
...
{{--                                        <input type="hidden" name="profession_id[]">--}}
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="usr"> Industry Category <strong style="color:red;">*</strong></label>
                                                    <select class="form-control heading select2" name="industry_category[]" multiple="multiple" required="" style="width: 100%;">
                                                        <option>Please Select</option>
                                                        @foreach($industryCategories as $id => $industryCategory)
                                                            <option value="{{$id}}" {{old('industry_category_id') == $id?'selected':''}}>{{$industryCategory}}</option>
                                                        @endforeach
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="0" max="9"  name="single_account_code" id="additional-category-account-code" class="form-control" placeholder="  Short Order" autocomplete="off" maxlength="1">
                                                    <small class="error_msg"></small>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control heading category" id="category" name="category" required="">
                                                            <option>Please Select</option>
                                                            @foreach($accountCodeCategories as $accountCodeCategory)
                                                                <option value="{{$accountCodeCategory->id}}" data-code="{{$accountCodeCategory->code}}">{{$accountCodeCategory->name}}-{{$accountCodeCategory->id}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
                                           ...
                                           <div class="row">
                                               <div class="col-md-6">
                                                   <div class="form-group">
                                                       ...
                                                       <input type="number" min="0" max="9" name="single_account_code" id="sub-category-account-code" class="form-control" placeholder="  Short Order" autocomplete="off" maxlength="1">
                                                       <small class="error_msg"></small>
                                                   </div>
                                               </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('edit.master.account.code')}}" method="POST">
                                {{csrf_field()}}
