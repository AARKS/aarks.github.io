                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    Results for All Profession
                                    @can('admin.profession.create')
                                    <a class="table-header bg-danger" style="float: right !important; padding-right: 10px; background: #5cb85c;text-decoration: none" href="{{ route('profession.create') }}">
                                ...
                                <div>
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        <tr>
                                            ...
                                            @canany(['admin.profession.edit', 'admin.profession.delete'])
                                        ...
                                        @foreach($professions as $index => $profession)
                                            <tr>
                                                ...
                                                <td>{{ $profession->industry_category_names }}</td>
                                                @canany(['admin.profession.edit', 'admin.profession.delete'])
                                                <td class="center">
                                                    <div>
                                                        @can('admin.profession.edit')
                                                        <a class="green" href="{{ route('profession.edit', $profession->id)}}">
                                                            <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                        </a>
                                                        @endcan
                                                        &nbsp;
                                                        @can('admin.profession.delete')
                                                        <a class='red' href='javascript:void(0)'>
                                                            <i class='ace-icon fa fa-trash-o bigger-130 delete_link' data-delete_url='{{ route('profession.destroy', $profession->id) }}'></i>
                                                        </a>
                                                        @endcan
                                                    </div>
                                                </td>
    ...
    <script>
        $(document).ready(function(){
            $(".delete_link").on('click', function(){
                ...
                $("#default-delete-form").attr("action", delete_url);
                $("#default-delete-modal").modal('show');
            });
        });
    </script>
