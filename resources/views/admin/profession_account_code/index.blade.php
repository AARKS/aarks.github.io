                            ...
                            <div class="form-group">
                                <select class="form-control" onchange="location = this.value">
                                    ...
                                    @foreach($professions as $profession)
                                        <option value="{{ route('account-code.index', $profession->id) }}" @if($profession->id == $selected_profession->id) selected @endif>{{$profession->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </form>
                ...
                <div class="row">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                           <div class="row">
                               <div class="col-md-10">
                                   <h3 class="panel-title" style="margin:15px;"><i class="fa fa-bars" aria-hidden="true"></i> Chart Account</h3>
                               </div>
                               @if (!$selected_profession->is_master_account_code_synced && $selected_profession->can_perform_sync)
                               <div class="col-md-2 text-right">
                                   <a class="btn btn-success" href="{{route('master-account-code.sync', $selected_profession->id)}}"><b>Sync Master Chart</b></a>
                               </div>
                               @endif
                           </div>
                        </div>
                                                ...
                                                @if($accountCode->additional_category_id == $additionalCategory->id)
                                                    <tr>
                                                        <td style="color: #1B6AAA">  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <a type="button"  class="edit-account-code" data-id="{{$accountCode->id}}" data-name="{{$accountCode->name}}" data-note="{{$accountCode->note}}" style="cursor: pointer">
                                                                {{$accountCode->name}}
                                                            </a>
                                                            @else
                    ...
                    <div class="panel panel-success mainform">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="post" action="{{URL::to(route('create.account.code'))}}">
                                {{csrf_field()}}
                                <input type="hidden" name="profession_id" id="profession_id" value="{{$selected_profession->id}}">
                                <div class="row">
{{--                                    industry Category--}}
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label for="usr"> Industry Category <strong style="color:red;">*</strong></label>
                                            <select class="form-control heading select2" id="industry_category_id" name="industry_category_id[]" multiple="multiple" required style="line-height: 3px;">
                                                <option value="">Please Select</option>
                                                @foreach($industryCategories as $industryCategory)
                                                    <option value="{{$industryCategory->id}}" {{old('industry_category_id') == $industryCategory->id?'selected':''}}>{{$industryCategory->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control category" id="category" name="category" required>
                                                ...
                                                @foreach($accountCodeCategories as $accountCodeCategory)
                                                    <option value="{{$accountCodeCategory->id}}" data-code="{{$accountCodeCategory->code}}" {{old('category') == $accountCodeCategory->id?'selected':''}}>{{$accountCodeCategory->name}}-{{$accountCodeCategory->code}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="additional_category" name="additional_category" required="">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="account_name" id="account" class="form-control" placeholder="Column Name" value="{{old('account_name')}}">
                                    ...
                                    <div class="col-md-2">
                                        <label for="usr">Account Code <strong style="color:red;">*</strong></label>
                                            <div class="input-group">
                                                <span type="text" style="width: 30%" id="auto-code" name="auto-code" class="form-control text-center" autocomplete="off" readonly></span>
                                                <input type="text" style="width: 60%" id="user-code" name="account_code" class="form-control" autocomplete="off" placeholder="3 digit" maxlength="3" value="{{old('account_code')}}" }}>
                                                <input type="hidden" style="width: 60%" id="account_code" class="form-control" autocomplete="off">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="1" placeholder="Note here........." class="form-control" id="note" name="note" >{{old('note')}}</textarea>
                                            @if($errors->has('note'))
...
{{--                                            <a href="https://www.aarks.com.au/System_configuration/sendEmail/38" class="btn btn-primary"><i class="fa fa-check" aria-hidden="true"></i> Send Email</a>--}}
                                            <button type="submit" class="btn btn-primary submit submit-btn"><i class="fa fa-check" aria-hidden="true"></i> Add</button>
                                            <button type="button" class="btn btn-danger cancelAdd"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button>
                                        </div>
                                    </div>
...
{{--                    Add new Additional Category--}}
                    ...
                    <div>
                        <div class="panel panel-success add-additional-category" style="display:none;">
                            ...
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bars" aria-hidden="true"></i> Add New Sub Sub Group</h3>
                            </div>
                                ...
                                <form method="post" action="{{URL::to(route('create.additional.category'))}}">
                                        ...
                                        <input type="hidden" name="profession_id" value="{{$profession->id}}">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control heading select2" id="" name="industry_category[]" required="" multiple style="width: 100%">
                                                        <option>Please Select</option>
                                                        @foreach($industryCategories as $industryCategory)
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control heading category" id="category" name="category" required="">
                                                        <option>Please Select</option>
                                                        @foreach($accountCodeCategories as $accountCodeCategory)
                                                            <option value="{{$accountCodeCategory->id}}" data-code="{{$accountCodeCategory->code}}">{{$accountCodeCategory->name}}-{{$accountCodeCategory->code}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="additional_category_name" id="heading_name" class="form-control" placeholder="  Column Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  name="single_account_code" id="additional-category-account-code" class="form-control" placeholder="  Short Order" autocomplete="off" >
                                                    <small class="error_msg"></small>
                                                </div>
                                            </div>
                                    </div>
                                    <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    <label for="usr">Note</label>
                                                    <textarea rows="1" placeholder="Note here........." class="form-control" id="note" name="note"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="panel-footer">
                                        ...
                                        <div class="row">
                                            <div class="pull-right">
                                                ...
                                                <button type="submit" class="btn btn-primary submit-btn"><i class="fa fa-check" aria-hidden="true"></i> Add</button>
                                                <button type="button" id="cancelAdd" class="btn btn-danger cancel"><i class="fa fa-times" aria-hidden="true"></i> Cancel</button>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="profession_id" value="{{$profession->id}}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="sub_category_name" id="heading_name" class="form-control" placeholder="  Column Name">
                                                </div>
                                            </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  name="single_account_code" id="sub-category-account-code" class="form-control" placeholder="  Short Order" autocomplete="off" >
                                                    <small class="error_msg"></small>
...
{{--            Edit Account Code Modal--}}
            <div class="modal fade" id="edit-account-code" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('edit.account.code')}}" method="POST">
                                {{csrf_field()}}
                                <input type="hidden" name="id" class="form-control" id="id">
                                <input type="hidden" name="profession_id" class="form-control" id="profession_id" value="{{$selected_profession->id}}">
                                <div class="form-group">
