                    ...
                    <div class="col-xs-12">
                        ...
                        <form class="form-horizontal" action="{{ route('service.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right" style="margin-right:10px;margin-left: 4%;"> Service Name</label>
                                <div class="col-sm-9">
                                    <div class="row">
                                        <input type="text" name="name"  value="{{old('name')}}" placeholder="Enter Service Name" class="col-xs-10 col-sm-8" />
                                    </div>
                                    <div class="row">
                                        @if($errors->has('name'))
