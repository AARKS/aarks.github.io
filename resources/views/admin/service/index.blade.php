                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <div class="table-header">
                                    ...
                                    <a class="table-header bg-danger" style="float: right !important; padding-right: 10px;background: #5cb85c" href="{{ route('service.create') }}">
                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        ...
                                        @foreach($services as $index => $service)
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <div>
                                                        <a class="green" href="{{ route('service.edit', $service->id)}}">
